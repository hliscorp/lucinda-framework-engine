...
require("vendor/lucinda/security/src/authorization/DAOAuthorization.php");
...
class DAOAuthorizationWrapper extends AuthorizationWrapper
{
    ...
    public function __construct(\SimpleXMLElement $xml, \Lucinda\MVC\STDOUT\Request $request, $userID)
    {
        ...
        if (!($userDAO instanceof \Lucinda\WebSecurity\UserAuthorizationDAO)) {
            throw new  \Lucinda\MVC\STDOUT\ServletException("Class must be instance of UserAuthorizationDAO!");
        }
